...
The file *percolation_tester_FC_visualization.py* takes in an input for number of grains and hemispherical shell parameters to output an interactive visualization of force chains, number of force chains, and the number of grains participating in the force chains.
